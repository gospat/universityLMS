...
if (class_exists(\local_ulms_auth\local\service\landing_page_service::class) && !isguestuser()) {
    $routingservice = new \local_ulms_auth\local\service\landing_page_service();
    $routingservice->redirect_to_url(
        $routingservice->get_courses_url_for_current_user(),
        '',
